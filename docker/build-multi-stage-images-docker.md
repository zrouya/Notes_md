...
5. **Flexibilité et modularité** : il est possible de construire **plusieurs artefacts ou images** à partir du **même Dockerfile**, en sélectionnant différentes étapes comme cibles, par exemple pour **différents environnements** (développement, test, production...).
