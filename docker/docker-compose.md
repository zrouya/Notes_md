...
- Un [[fichier-docker-compose|fichier yaml]] qui décrit les différentes options de build ou de run : des [[containers-docker|containers]], des [[gestion-reseau-docker|networks]], des [[volumes-docker|volumes]], etc.
