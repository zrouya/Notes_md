...
La gestion réseau de l'environnement Docker est basée sur l'approche **"Batteries included, but removable"** : la configuration par défaut fonctionne dans la plupart des cas, mais reste facile à adapter.

## Réseaux virtuels et conteneurs
...
Il est possible d'utiliser des [[drivers-reseau-docker|drivers réseau]] Docker additionnels pour enrichir les fonctionnalités et possibilités de configuration.
