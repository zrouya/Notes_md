---
tags: [azure, conteneurs, aci]
---

# Azure Container Group

Un Azure Container Group est un regroupement de conteneurs Azure, qui partagent **le même hôte**. Lorsqu'une ressource [[azure-container-instances|Azure Container Instances]] crée une instance de conteneur, elle le crée toujours au sein d'un **Container Group**.

## Création via Azure CLI

Par exemple, via [[azure-cli|Azure CLI]], pour créer un **conteneur unique**, utiliser la commande (avec exemples de paramètres) :
```bash
