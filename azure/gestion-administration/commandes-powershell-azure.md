...
Pour **se connecter** à un **compte Azure** à partir de **PowerShell**, la commande ``Connect-AzAccount`` permet plusieurs méthodes d'authentification. Voir la [documentation d'authentification](https://learn.microsoft.com/fr-fr/powershell/azure/authenticate-azureps?view=azps-11.5.0&viewFallbackFrom=azps-11.1.0).

Voir la [documentation Microsoft](https://learn.microsoft.com/en-us/powershell/azure/get-started-azureps?view=azps-11.5.0).
