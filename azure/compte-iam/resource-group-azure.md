---
tags: [azure, compte, iam]
---

# Resource Group Azure

Un groupe de ressources Azure permet de **rassembler des services** Azure au sein d'un même **groupe logique**. Il s'agit le plus généralement d'une **application**, consommant un ensemble de ressources Azure.

## Avantages du rassemblement en resource groups
...
3. **Facturation** : Bien que le Resource Group lui-même ne change pas le modèle de facturation des ressources qu'il contient, il facilite le suivi des coûts. Vous pouvez voir les coûts accumulés par Resource Group, ce qui simplifie la compréhension d'où les coûts sont engagés dans votre organisation.
