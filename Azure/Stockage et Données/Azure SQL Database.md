...
- Un **mode d'authentification** ([[Microsoft Entra ID (ex. Azure Active Directory)|Azure Entra]], anciennement **Azure Active Directory**, ou **authentification SQL**, ou les 2).
...
Une fois cet élément de configuration créé, la connection string est accessible au sein du code de l'application via le service (injecté) *IConfiguration*.