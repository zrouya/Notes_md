...
Les Azure Functions sont les éléments d'une ressource [[Azure Function App]], affichés dans la section **Overview/Functions** du portail Azure, après avoir sélectionné la ressource Function App correspondante.

![[Pasted image 20240813162238.png]]
...
- Comme pour une [[Azure App Configuration|Azure Web App]], il est possible d'ajouter des **items de configuration** à une Azure Function (section "**Settings/Configuration**"), y compris des **connection strings**, dans l'onglet correspondant.
