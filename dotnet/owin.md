...
Couche d'abstraction entre les applications Web .NET Framework et les serveurs HTTP hôtes. A permis aux applications .NET de se découpler de `System.Web` (et donc de **IIS**).

Owin a introduit la notion de middleware, reprise par .NET Core par la suite. Chronologiquement :
